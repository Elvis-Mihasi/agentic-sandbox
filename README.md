...
The Kubernetes deployment enables metrics on container port `9100`. To read
them from a running pod, use `kubectl port-forward deployment/sandbox-app
9100:9100` and request `http://localhost:9100/`.
